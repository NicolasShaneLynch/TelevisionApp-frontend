...
export class SidenavComponent {
  ...
  ngOnInit(): void {
    ...
    if (loggedUser.usertype=="SUPERADMIN") this.dataSource.data = SIDENAV_MENU_CONSTANT_SUPER;
    else this.dataSource.data = SIDENAV_MENU_CONSTANT_ADMIN;
