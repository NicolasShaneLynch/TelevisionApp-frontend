...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        resolve: {
          // Il resolve è un oggetto il quale all'interno ha una variabile custom ( Scegliamo noi come nominarla )
      ...
      },
      {
        ...
        loadComponent: () => import('./visualizza-utente/visualizza-utente.component')
      },
      {
        path: 'insertuser',
        title: 'Aggiungi utente',
        loadComponent: () => import('./inserisci-utente/inserisci-utente.component')
      },
      {
        path: 'edituser/:id',
        title: 'Modifica utente',
        loadComponent: () => import('./modifica-utente/modifica-utente.component')
      },
    ],
  },
];
